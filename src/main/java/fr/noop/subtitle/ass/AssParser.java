...
public class AssParser implements SubtitleParser {
    ...
    public AssObject parse(InputStream is, boolean strict) throws IOException, SubtitleParsingException {
        ...
        while ((textLine = br.readLine()) != null) {
            ...
            if (cursorStatus == CursorStatus.NONE && textLine.equals("[V4+ Styles]")) {
                cursorStatus = CursorStatus.SIGNATURE;
                continue;
            }
            if (cursorStatus == CursorStatus.NONE && textLine.equals("Style")) {
                continue;
            }
    ...
    private List<SubtitleLine> parseCueText(String cueText) {
        ...
        AssLine cueLine = null; // Current cue line
